...
\begin{itemize}
	\item \verb|convert_scal.out| and \verb|convert_latt.out|: Writing the contents of a \verb|_scal| observable or a lattice type observables (that is \verb|_eq|, and \verb|_tau|) to an HDF5 file. E.g. writing bins from \verb|some_obs_scal|, \verb|some_obs_eq| and \verb|some_obs_tau| to data.h5 is done by executing.
	\vspace{-\baselineskip}
	\begin{lstlisting}[style=bash]
